...
def test_mark_ready_and_unlock_are_in_scope():
...
def test_activate_pause_resume_archive_are_all_out_of_scope():
    assert _in_scope("POST", "/mail/campaigns/c1/activate") is False
