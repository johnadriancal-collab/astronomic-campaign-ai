  ...
  return (
    ...
    >
      <SwitchPrimitive.Thumb
        ...
        className={cn(
          "pointer-events-none block h-4 w-4 rounded-full bg-background shadow-lg ring-0 transition-transform data-[unchecked]:translate-x-0.5 data-[checked]:translate-x-4"
        )}
      />
    </SwitchPrimitive.Root>
  )
